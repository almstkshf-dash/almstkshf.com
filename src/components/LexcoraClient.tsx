    ...
    return (
        <main className="min-h-screen pb-20 bg-background text-foreground">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-gradient-to-b from-primary/10 to-transparent blur-3xl rounded-full opacity-30 pointer-events-none"></div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 space-y-8 text-center lg:text-left rtl:lg:text-right">
                            ...
                            <motion.h1
                                ...
                                className="text-6xl lg:text-8xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-foreground to-muted-foreground"
                            >
                                {t("title")}
                            </motion.h1>
                            ...
                            >
                                ...
                                <Link
                                    href={`/${locale}/contact`}
                                    className="px-8 py-4 bg-card border border-border text-foreground rounded-xl font-bold hover:bg-accent transition-all outline-none focus:ring-2 focus:ring-border focus:ring-offset-2 focus:ring-offset-background flex items-center justify-center"
                                >
                                    {t("cta_demo")}
                                </Link>
                            </motion.div>
                        ...
                        <motion.div
                            ...
                            className="flex-1 w-full max-w-xl relative rounded-3xl border border-border bg-card/50 backdrop-blur-xl group shadow-2xl shadow-primary/20"
                        >
                            <Image
                            ...
                            <div key={cat.id} className="space-y-12">
                                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-border pb-12">
                                    <div className="space-y-4">
                                        ...
                                        <h2 className="text-4xl md:text-5xl font-bold text-foreground">{t(`sections.${cat.id}.subtitle`)}</h2>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {cat.items.map((item, itemIdx) => (
                                        <motion.div
                                            ...
                                            className="group p-8 bg-card border border-border rounded-3xl hover:bg-muted/50 transition-all hover:border-primary/30"
                                        >
            ...
            <section id="faq" className="py-24 bg-muted/20">
                <Container>
                    <div className="text-center space-y-4 mb-20">
                        <h2 className="text-4xl md:text-6xl font-bold text-foreground">{t("faq.title")}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {["what_is", "deadlines", "database", "customization", "financials", "permissions"].map((key, idx) => (
                            <motion.div
                                ...
                                className="p-8 bg-card border border-border rounded-[2.5rem] hover:bg-muted/30 transition-all group relative overflow-hidden"
                            >
                                ...
                                <div className="space-y-6 relative z-10">
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center border border-primary/20 text-primary font-bold text-sm">
                                            0{idx + 1}
                                        </div>
            ...
            <section className="py-24 border-t border-border bg-background">
                <Container>
                    <div className="text-center space-y-12">
                        <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-muted-foreground">{t("trusted")}</h2>
                        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
                            {/* Placeholder Logos */}
                            <div className="text-2xl font-black italic text-foreground">LAW FIRM ALPHA</div>
                            <div className="text-2xl font-black italic text-foreground">GLOBAL LEGAL CO</div>
                            <div className="text-2xl font-black italic text-foreground">EMIRATES COUNSEL</div>
                            <div className="text-2xl font-black italic text-foreground">ZED & ASSOCIATES</div>
                        </div>
                    </div>
                </Container>
            </section>
                ...
                <Container>
                    <div className="relative rounded-[3rem] overflow-hidden bg-primary p-12 md:p-24 text-center space-y-8">
                        ...
                        <div className="flex justify-center flex-wrap gap-4 relative z-10">
                            <Link
                                href="https://lexcora-mbh.com"
                                className="px-10 py-5 bg-background text-primary rounded-2xl font-bold hover:scale-105 transition-transform shadow-lg"
                            >
                                {t("cta_start")}
                            </Link>
                            <Link
                                href={`/${locale}/contact`}
                                className="px-10 py-5 bg-primary-foreground/10 text-primary-foreground border border-primary-foreground/20 rounded-2xl font-bold hover:scale-105 transition-transform backdrop-blur-sm"
                            >
                                {t("cta_demo")}
                            </Link>
                        </div>
