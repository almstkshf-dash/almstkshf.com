            ...
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-foreground/70 dark:text-slate-400 text-sm leading-relaxed max-w-xs">
                            {t('description')}
                        </p>
                            ...
                            {NAVIGATION_ITEMS.filter(item => !item.children && !['lexcora', 'contact', 'faq'].includes(item.label)).map((item) => (
                                <li key={item.label}>
                                    <Link
                                        ...
                                        className="text-foreground/70 dark:text-slate-400 hover:text-foreground transition-colors text-sm flex items-center gap-2 group"
                                    >
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3 text-foreground/70 dark:text-slate-400 text-sm hover:text-foreground transition-colors group cursor-pointer">
                                <MapPin className="w-5 h-5 text-primary flex-shrink-0" aria-hidden="true" />
                                <span>{t('address_dubai')}<br />{t('address_abu_dhabi')}</span>
                            </li>
                            <li className="flex items-center gap-3 text-foreground/70 dark:text-slate-400 text-sm hover:text-foreground transition-colors group">
