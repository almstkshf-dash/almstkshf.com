...
import { Loader2, ExternalLink, Trash2, ShieldCheck, AlertCircle, HelpCircle, Globe2, Newspaper, MessageSquare, BookOpen, Printer, Heart, Share2, MessageCircle, Edit, History, FolderPlus } from 'lucide-react';
 ...
 */
export const getSourceBadgeColor = (type: string) => {
    switch (type) {
