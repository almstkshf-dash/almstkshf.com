                        ...
                        <div className="space-y-8">
                            <section className="bg-card p-8 rounded-2xl border border-border shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="twitter-key" className="text-sm font-bold text-foreground/80">{t('twitter_key')}</label>
                                        <input
                                            id="twitter-key"
                                            name="twitter-key"
                                            type="password"
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="twitter-consumer-key" className="text-sm font-bold text-foreground/80">{t('twitter_consumer_key')}</label>
                                        <input
                                    ...
                                    <div className="space-y-2 md:col-span-2">
                                        <label htmlFor="twitter-consumer-secret" className="text-sm font-bold text-foreground/80">{t('twitter_consumer_secret')}</label>
                                        <input
