...
export default function DashboardClient() {
    ...
    const handleExport = async (type: 'excel' | 'pdf') => {
        ...
        const exportTranslations = {
            ...
            ave: tExport('ave'),
            brand_name: appSettings?.brandName || tExport('brand_name'),
            brand_tagline: appSettings?.brandTagline || tExport('brand_tagline'),
            footer_url: appSettings?.footerUrl || tExport('footer_url'),
            logo_url: appSettings?.logoUrl || undefined,
