            ...
            <Container>
                ...
                <div className="mb-16 text-center max-w-4xl mx-auto">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-3 mb-6 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20"
                    >
                        <UserCheck className="w-5 h-5 text-blue-400" />
                        <span className="text-blue-300 font-semibold tracking-wide uppercase text-sm">{tNav("kyc_compliance")}</span>
                    </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 hover:border-blue-500/30 transition-all hover:bg-slate-900 group"
                        >
                ...
                >
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto space-y-8">
                        ...
                        <div className="flex flex-wrap justify-center gap-4">
                            <Link
                                href={`/${locale}/contact`}
                                className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold transition-all shadow-lg shadow-blue-900/20 transform hover:-translate-y-1"
                            >
                                {tNav("contact")}
                            </Link>
                        </div>
